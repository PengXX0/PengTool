...
namespace Peng.AppTool.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            list.Add(new UserProfile { UserId = 1, UserName = "张三" });
            list.Add(new UserProfile { UserId = 2, UserName = "李四" });
            list.Add(new UserProfile { UserId = 3, UserName = "王五" });
            list.Add(new UserProfile { UserId = 4, UserName = "赵六" });
            list.Add(new UserProfile { UserId = 5, UserName = "田七" });
            list.Add(new UserProfile { UserId = 6, UserName = "王八" });
            return View(list);
        }
