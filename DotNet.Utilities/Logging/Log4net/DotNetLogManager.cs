...
namespace DotNet.Utilities.Log4net
{
    public class DotNetLogManager
    {
        ...
        public static IDotNetLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IDotNetLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IDotNetLog Exists(Assembly assembly, string name)
        {
        ...
        public static IDotNetLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IDotNetLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IDotNetLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public static IDotNetLog GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IDotNetLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IDotNetLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public static IDotNetLog GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IDotNetLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IDotNetLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static IDotNetLog WrapLogger(ILogger logger)
        {
            return (IDotNetLog)wrapperMap.GetWrapper(logger);
        }
        ...
        private static IDotNetLog[] WrapLoggers(ILogger[] loggers)
        {
            IDotNetLog[] results = new IDotNetLog[loggers.Length];
        ...
        {
            return new DotNetLogImpl(logger);
        }
        #endregion
    }
}