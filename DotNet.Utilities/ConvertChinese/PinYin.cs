...
namespace DotNet.Utilities.ConvertChinese
{
    public class PinYin
    {
        public string GetFirstLetter(string chineseCharacter)
        {
            ...
            const string lsSecondCh = "Ў°ЎҐЎ£Ў§Ў•Ў¶ЎІЎ®Ў©Ў™ЎЂЎђЎ≠ЎЃЎѓЎ∞Ў±Ў≤Ў≥ЎіЎµЎґЎЈЎЄЎєЎЇЎїЎЉЎљ" +
            ...
            foreach (var t in chineseCharacter)
            {
                ...
                else if (array[0] >= 176 && array[0] <= 215)
                {
                    ...
                    if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "‘—", StringComparison.Ordinal) >= 0)
                        returnPy += "z";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "—є", StringComparison.Ordinal) >= 0)
                        returnPy += "y";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "ќф", StringComparison.Ordinal) >= 0)
                        returnPy += "x";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "Ќџ", StringComparison.Ordinal) >= 0)
                        returnPy += "w";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "Ћъ", StringComparison.Ordinal) >= 0)
                        returnPy += "t";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "»ц", StringComparison.Ordinal) >= 0)
                        returnPy += "s";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "»ї", StringComparison.Ordinal) >= 0)
                        returnPy += "r";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "∆Џ", StringComparison.Ordinal) >= 0)
                        returnPy += "q";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "≈Њ", StringComparison.Ordinal) >= 0)
                        returnPy += "p";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "≈ґ", StringComparison.Ordinal) >= 0)
                        returnPy += "o";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "ƒ√", StringComparison.Ordinal) >= 0)
                        returnPy += "n";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "¬и", StringComparison.Ordinal) >= 0)
                        returnPy += "m";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "јђ", StringComparison.Ordinal) >= 0)
                        returnPy += "l";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "њ¶", StringComparison.Ordinal) >= 0)
                        returnPy += "k";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "їч", StringComparison.Ordinal) >= 0)
                        returnPy += "j";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "єю", StringComparison.Ordinal) >= 0)
                        returnPy += "h";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "ЄЅ", StringComparison.Ordinal) >= 0)
                        returnPy += "g";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "ЈҐ", StringComparison.Ordinal) >= 0)
                        returnPy += "f";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "ґк", StringComparison.Ordinal) >= 0)
                        returnPy += "e";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "іо", StringComparison.Ordinal) >= 0)
                        returnPy += "d";
                    else if (String.Compare(t.ToString(CultureInfo.InvariantCulture), "≤Ѕ", StringComparison.Ordinal) >= 0)
                        returnPy += "c";
        ...
        /// »°ЇЇ„÷∆і“фµƒ „„÷ƒЄ
        /// </summary>
        /// <param name="chineseCharacter">ЇЇ„÷</param>
        /// <returns> „„÷ƒЄ</returns>
